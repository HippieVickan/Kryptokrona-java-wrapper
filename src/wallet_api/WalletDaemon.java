...
public class WalletDaemon {
	...
	public void createWallet(String fileName, String password)
			throws WalletException, IOException, InterruptedException {
		JsonObjectBuilder params = getGenericParameters();
		params.add("filename", fileName);
		params.add("password", password);
	...
	public void importByKey(String fileName, String password, int scanHeight, String privateViewKey,
			String privateSpendKey) throws WalletException, IOException, InterruptedException {
	...
	public void importByMnemonic(String fileName, String password, int scanHeight, String mnemonic)
			throws WalletException, IOException, InterruptedException {
	...
	public void importViewOnly(String fileName, String password, int scanHeight, String viewKey, String adress)
			throws WalletException, IOException, InterruptedException {
	...
	public String getPrimaryAddress() throws WalletException, IOException, InterruptedException {
		...
		if (e == null)
			return req.RESULT.getString("address");
		else
			throw e;
	}
	...
	public KeyPair createAddress() throws WalletException, IOException, InterruptedException {
		...
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
		if (e == null)
			return new KeyPair(req.RESULT.getString("publicSpendKey"), req.RESULT.getString("privateSpendKey"),
					req.RESULT.getString("address"));
		else
			throw e;
	}

	public String importSubwallet(int height, String privKey)
			throws WalletException, IOException, InterruptedException {
		JsonObjectBuilder params = Json.createObjectBuilder();
	...
	public String importSubwalletView(int height, String pubKey)
			throws WalletException, IOException, InterruptedException {
		JsonObjectBuilder params = Json.createObjectBuilder();
		params.add("scanHeight", height);
	...
	public String createIntegratedAddress(String addr, String ID)
			throws WalletException, IOException, InterruptedException {
		Request req = api.noParameterWalletRequest("/addresses/" + addr + "/" + ID,
				getGenericHeaders().remove("accept").build(), "GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);

		if (e == null)
			return req.RESULT.getString("integratedAddress");
		else
			throw e;
	}
	...
	public String getKeys() throws IOException, InterruptedException, WalletException {
		...
		if (e == null)
			return req.RESULT.getString("privateViewKey");
		else
			throw e;
	}

	public KeyPair getKeyPairAdress(String address) throws WalletException, IOException, InterruptedException {
		Request req = api.noParameterWalletRequest("/keys/" + address, getGenericHeaders().remove("accept").build(),
				"GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);

		if (e == null)
			return new KeyPair(req.RESULT.getString("privateSpendKey"), req.RESULT.getString("publicSpendKey"),
					address);
		else
			throw e;
	}
	...
	public String getMnemonic(String address) throws WalletException, IOException, InterruptedException {
		Request req = api.noParameterWalletRequest("/keys/mnemonic" + address,
				getGenericHeaders().remove("accept").build(), "GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);

		if (e == null)
			return req.RESULT.getString("mnemonicSeed");
		else
			throw e;
	}
	...
	public WalletTransactionData[] getTransactions() throws IOException, InterruptedException, WalletException {
		...
		if (e == null) {
			...
			for (int i = 0; i <= txs.size() - 1; i++) {
				System.out.println(txs.getJsonObject(i));
	...
	public WalletTransactionData[] getTransactions(int start)
			throws IOException, InterruptedException, WalletException {
	...
	public WalletTransactionData[] getTransactions(int start, int end)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/" + start + "/" + end, getGenericHeaders().build(),
				"GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
	...
	public WalletTransactionData[] getTransactions(String address)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/address/" + address, getGenericHeaders().build(),
				"GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
	...
	public WalletTransactionData[] getTransactions(String address, int start)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/address/" + address + "/" + start,
				getGenericHeaders().build(), "GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
	...
	public WalletTransactionData[] getTransactions(String address, int start, int end)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/address/" + address + "/" + start + "/" + end,
				getGenericHeaders().build(), "GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
	...
	public WalletTransactionData getTransactionByHash(String hash)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/hash/" + hash, getGenericHeaders().build(), "GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);

		if (e == null)
			return new WalletTransactionData(req.RESULT.getJsonObject("transactions"));
		else
			throw e;
	}

	public WalletTransactionData[] getUnconfirmedTransactions()
			throws IOException, InterruptedException, WalletException {
	...
	public WalletTransactionData getUnconfirmedTransactionByHash(String hash)
			throws IOException, InterruptedException, WalletException {
		Request req = api.noParameterWalletRequest("/transactions/unconfirmed/" + hash, getGenericHeaders().build(),
				"GET");
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
	...
	public TransactionStatus sendTransaction(PreparedTransaction p)
			throws IOException, InterruptedException, WalletException {
		JsonObjectBuilder params = getGenericParameters();
		...
		Request req = api.walletRequest("/transactions/send/basic", params.build(), getGenericHeaders().build(),
				"POST");
		if (req.RESPONSE_CODE > 202) {
			String line = "";
			BufferedReader errors = new BufferedReader(new InputStreamReader(req.ERROR_STREAM));
		...
		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
		if (e == null)
			return new TransactionStatus(req.RESULT);
		else
			throw e;
	...
	public double getBalance() throws WalletException, IOException, InterruptedException {
		Request req = api.noParameterWalletRequest("/balance", getGenericHeaders().build(), "GET");

		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
		if (e == null)
			return req.RESULT.getInt("unlocked");
		else
			throw e;
	}
	...
	public double getSyncPercentage() throws IOException, InterruptedException, WalletException {

		Request req = api.noParameterWalletRequest("/status", getGenericHeaders().build(), "GET");

		WalletException e = handleStandardErrorCodes(req.RESPONSE_CODE);
		JsonObject response = req.RESULT;
		System.out.println(response.toString());
		double networkHeight = response.getInt("networkBlockCount");
		double walletHeight = response.getInt("walletBlockCount");
		if (e == null)
